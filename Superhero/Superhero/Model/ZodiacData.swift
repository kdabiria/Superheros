...
var zodiacHero = [
    zodiacHeros(id: 1, name: "Aquarius", image: "Rocket Raccoon",
    ...
    zodiacHeros(id: 2, name: "Pisces", image: "Aquaman",
    ...
    zodiacHeros(id: 3, name: "Aries", image: "Wolverine",
    ...
    zodiacHeros(id: 4, name: "Taurus", image: "Gambit",
    ...
    zodiacHeros(id: 5, name: "Gemini", image: "Iron Man",
    ...
    zodiacHeros(id: 6, name: "Cancer", image: "Captain America",
    ...
    zodiacHeros(id: 8, name: "Virgo", image: "Spider-Man",
    ...
    zodiacHeros(id: 9, name: "Libra", image: "Superman",
    ...
    zodiacHeros(id: 10, name: "Scorpio", image: "Green Lantern",
    ...
    zodiacHeros(id: 11, name: "Sagittarius", image: "Hulk",
    ...
    zodiacHeros(id: 12, name: "Capricorn", image: "Professor X",
